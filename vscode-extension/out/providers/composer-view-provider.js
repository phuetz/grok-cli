...
exports.ComposerViewProvider = void 0;
const vscode = __importStar(require("vscode"));
class ComposerViewProvider {
    constructor(_extensionUri, aiClient, diffManager) {
     ...
     */
    async handleCompose(instruction) {
...
Make the requested changes:`,
            ...
            if (this.pendingChanges.length === 0) {
                ...
                vscode.window.showInformationMessage(`${this.pendingChanges.length} file(s) will be modified. Review changes in Composer.`);
            }
        }
        catch (error) {
     ...
     */
    parseFileChanges(response, originalFiles) {
        const changes = [];
...
exports.ComposerViewProvider = ComposerViewProvider;
ComposerViewProvider.viewType = 'codebuddy.composerView';
//# sourceMappingURL=composer-view-provider.js.map